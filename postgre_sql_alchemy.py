...
db_url = 'postgresql+psycopg2://postgres:1991@localhost/postgres'
...
def insert():
    try:
        user_information = User(name='samir', lname='abdelkader', email='samir@gmail.com',
                                text='Im a software developer and ilove whrite articles', password='1994')
...
def update():
    try:
        ...
        update_info.name = 'samir'
        update_info.email = 'samir@gmail.com'
        db.session.commit()
